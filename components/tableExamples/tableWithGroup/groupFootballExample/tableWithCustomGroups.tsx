...
const headers: BaseTableHeader[] = [
  ...
  { text: "Team", id: "team", width: 120, hasFilter: true },
  { text: "#", id: "#", width: 60, hasFilter: true },
  { text: "Nation", id: "Nation", width: 80, hasFilter: true },
  { text: "Position", id: "Position", width: 80, hasFilter: true },
  { text: "Age", id: "Age", width: 80, hasFilter: true },
  { text: "Minutes", id: "Minutes", width: 80, hasFilter: true },
  { text: "Goals", id: "Goals", width: 80, hasFilter: true },
  { text: "Assists", id: "Assists", width: 80, hasFilter: true },
  {
    text: "Penalty Shoot on Goal",
    id: "Penalty Shoot on Goal",
    width: 120,
    hasFilter: true,
  },
  { text: "Penalty Shoot", id: "Penalty Shoot", width: 100, hasFilter: true },
  { text: "Total Shoot", id: "Total Shoot", width: 100, hasFilter: true },
  {
  ...
  { text: "Yellow Cards", id: "Yellow Cards", width: 100, hasFilter: true },
  { text: "Red Cards", id: "Red Cards", width: 100, hasFilter: true },
  { text: "Touches", id: "Touches", width: 80, hasFilter: true },
  { text: "Dribbles", id: "Dribbles", width: 80, hasFilter: true },
  { text: "Tackles", id: "Tackles", width: 80, hasFilter: true },
  { text: "Blocks", id: "Blocks", width: 80, hasFilter: true },
  {
    text: "Expected Goals (xG)",
    id: "Expected Goals (xG)",
    width: 120,
    hasFilter: true,
  },
  {
    text: "Non-Penalty xG (npxG)",
    id: "Non-Penalty xG (npxG)",
    width: 120,
    hasFilter: true,
  },
  {
    text: "Expected Assists (xAG)",
    id: "Expected Assists (xAG)",
    width: 120,
    hasFilter: true,
  },
  {
    text: "Shot-Creating Actions",
    id: "Shot-Creating Actions",
    width: 120,
    hasFilter: true,
  },
  {
    text: "Goal-Creating Actions",
    id: "Goal-Creating Actions",
    width: 120,
    hasFilter: true,
  },
  {
  ...
  { text: "Carries", id: "Carries", width: 80, hasFilter: true },
  {
    text: "Progressive Carries",
    id: "Progressive Carries",
    width: 120,
    hasFilter: true,
  },
  {
    text: "Dribble Attempts",
    id: "Dribble Attempts",
    width: 120,
    hasFilter: true,
  },
  {
    ...
    id: "Successful Dribbles",
    width: 120,
    hasFilter: true,
  },
  { text: "Date", id: "Date", width: 100, hasFilter: true },
]
